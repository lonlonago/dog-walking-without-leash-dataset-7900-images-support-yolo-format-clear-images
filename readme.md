# Dog walking without leash dataset 7900 images support YOLO format clear images

# Body

Dog Walking Without a Leash Dataset, 7900 images, supports YOLO format, clear images, complete annotations, suitable for training target detection models related to dog walking without a leash. The dataset is labeled and ready to use, saving you the hassle of setup.

Please send the download link of the cloud drive
